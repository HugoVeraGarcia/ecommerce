            ...
            {localStorage.getItem("token") ? (
              ...
              <>
                <div className="modal">
                  ...
                  {!isSign && (
                    <p onClick={() => setIsSign(true)} className="link">
                  ...
                  {isSign && <label htmlFor="name">First Name</label>}
                  {isSign && (
                    <input
                      type="text"
                      id="name"
                  ...
                  {isSign && <label htmlFor="last">Last Name</label>}
                  {isSign && (
                    <input
                      type="text"
                      id="last"
                  ...
                  {isSign && <label htmlFor="password">Password</label>}
                  {isSign && (
                    <input
                      type="password"
                      id="password"
                  ...
                  {isSign && (
                    <p onClick={() => setIsSign(false)} className="link">
